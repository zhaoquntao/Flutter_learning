              ...
              child: MediaQuery.removePadding(
                  ...
                  child: ListView(
                    children: [
                      ...
                      DiscorverCell(title: '支付', imageName: 'images/微信 支付.png'),
                      SizedBox(
                        height: 10,
                      ),
                      DiscorverCell(title: '收藏', imageName: 'images/微信收藏.png'),
                      Row(
                        children: [
                          Container(
                            color: Colors.white,
                      ...
                      DiscorverCell(title: '相册', imageName: 'images/微信相册.png'),
                      Row(
                        children: [
                          Container(
                            color: Colors.white,
                      ...
                      DiscorverCell(
                          title: '微信卡包', imageName: 'images/微信卡包.png'),
                      Row(
                        children: [
                          Container(
                            color: Colors.white,
                      ...
                      DiscorverCell(
                          title: '微信表情', imageName: 'images/微信表情.png'),
                      SizedBox(
                        height: 10,
                      ),
                      DiscorverCell(title: '设置', imageName: 'images/微信设置.png')
                    ],
                  )),
            ),
            Container(
